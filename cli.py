...
def main():
 ap=argparse.ArgumentParser(description='VPS-1 autonomous data factory')
 ...
 elif a.cmd=='pipeline': subprocess.run([sys.executable,str(ROOT/'pipeline/orchestrate.py')],check=True)
